    ...
    private void initialize() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt)
            {
                ...
                String email = textField_4.getText();//email  cel vechi
                String email1 = textField_1.getText();//email cel nou
...
*/
        ...
        Image img = new ImageIcon(this.getClass().getResource("/p6.png")).getImage();
        lblNewLabel_3.setIcon(new ImageIcon(img));
        lblNewLabel_3.setBounds(317, 73, 183, 114);
